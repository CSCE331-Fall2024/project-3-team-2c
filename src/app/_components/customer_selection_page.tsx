...
//   const drinks = api.menu.getMenuItemsByType.useQuery<Drink[]>("drink");
//   const entrees = api.menu.getMenuItemsByType.useQuery<Entree[]>("entree");
//   const appetizers = api.menu.getMenuItemsByType.useQuery<Appetizer[]>("appetizer");
//   const drinksData = drinks.data!;
//   const entreesData = entrees.data!;
//   const appetizersData = appetizers.data!;
  ...
  const renderItems = () => {
    ...
    return data.map((item) => {
      ...
      const isSelected = currentStepName 
        ? (selectedItems[currentStepName] ?? []).includes(item.name)
        : false;
      return (
        <div
          key={item.id}
