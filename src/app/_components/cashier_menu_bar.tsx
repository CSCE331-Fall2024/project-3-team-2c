 ...
 * MenuBar Component
 * 
 * This component renders a navigation bar with links and buttons for navigating
 * through different sections of the application, such as Home, All Items, Entrees,
 * Sides, Drinks, and Cart. It accepts callback functions as props to handle clicks
 * on the Cart, Home, and specific item category buttons.
 * 
