...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "account_user_id_idx" ON "panda_account" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "session_user_id_idx" ON "panda_session" USING btree ("user_id");